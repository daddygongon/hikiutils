...
これをsync, all\_latexをかけると図\ref{fig:CiteRefSystems}のようになります．latexの文献参照(cite, bibliography)，図表番号の参照(ref, label)が正常に処理されていることが確認できます．また，web表示した場合でもそれほご違和感なく読めるでしょう．
